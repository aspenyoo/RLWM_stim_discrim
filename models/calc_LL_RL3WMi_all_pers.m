function [LL] = calc_LL_RL3WMi_all_pers(pars,stimvaluesCell,corrCell,responseCell,test_learnblocknum,test_stimvalues,test_subjresp,condVec,logflag,fixparams)
