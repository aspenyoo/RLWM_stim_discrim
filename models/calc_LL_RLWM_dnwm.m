function LL = calc_LL_RLWM_dnwm(pars,stimvaluesCell,corrCell,responseCell,condVec,logflag,fixparams)
...
%    [alpha, neg_alpha, epsilon, lambda, dn_e, dn_c, dn_t ns3, ns6, beta]
...
for iblock = 1:nBlocks
    ...
    for itrial = 1:nTrials
        ...
        if (ichoice ~= -1)
            ...
            p_WM = 1/sum(exp(beta_WM .* (wmvalmat-wmvalmat(ichoice))));
