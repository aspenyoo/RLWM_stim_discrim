function [LL, QvalCell] = calc_LL_RLWM_dn_all_pers(pars,stimvaluesCell,corrCell,responseCell,test_learnblocknum,test_stimvalues,test_subjresp,condVec,logflag,fixparams)
